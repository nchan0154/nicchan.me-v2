...
<div class="video" style="aspect-ratio: 16/9;">
	<Youtube videoid="V-Gx0e5Gkzg"></Youtube>
</div>
...
<div class="post-callout">
	<h3 class="post-callout__title">Motion Warning</h3>
	<p class="post-callout__text">
		The next slide has a gif which demonstrates an unexpected scrolling
		appearance. Viewers with vestibular issues may wish to look away for a
		second.
	</p>
</div>
