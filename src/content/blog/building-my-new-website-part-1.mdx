---
title: "Building my new website: Ideation"
pubDate: "2023-09-16"
...
<Image
	src="https://res.cloudinary.com/nicchan/image/upload/v1698225054/color-wheel.png"
	width="980"
	height="703"
	alt="A chart where every single possible combination is overlaid on top of each other, with the word 'Yup' or 'Nope' if the combination is accessible."
/>
...
<Image
	src="https://res.cloudinary.com/nicchan/image/upload/v1694838055/personal-1.png"
	width="704"
	height="540"
	alt="Very barebones layout, there are some placeholder navigation icons, an unstyled start bar and a window with some homepage text."
/>
...
<div style="display: flex; gap: 1rem">
	<figure style="flex: calc(1024 / 768)">
		<Image
			src="https://res.cloudinary.com/nicchan/image/upload/v1694838056/personal-2.png"
			width="1024"
			height="768"
			alt="Our layout now has a big heading that says 'Home', and two windows of placeholder content. Our two windows are placed in an offset way to give the feeling of a messy desktop."
		/>
		<figcaption>Desktop progress</figcaption>
	</figure>
	<figure style="flex: calc(416 / 768)">
		<Image
			src="https://res.cloudinary.com/nicchan/image/upload/v1694838056/personal-3.png"
			width="416"
			height="768"
			alt="The same layout on mobile, where our two windows are stacked vertically."
		/>
...
[Read part two](/blog/building-my-new-website-part-2/)
