---
title: "Building my new website: Windows and View Transitions"
pubDate: "2023-10-25"
...
<Image
	src="https://res.cloudinary.com/nicchan/image/upload/v1698224962/personal-4.png"
	width="1024"
	height="768"
	alt="The homepage, now in dark mode. There's some more copy there, and an early version of the close icon for each window."
/>
...
<Image
	src="https://res.cloudinary.com/nicchan/image/upload/v1698224962/personal-5.png"
	width="1024"
	height="768"
	alt="The homepage now has a fully illustrated backdrop, a purple-y city sunset. There is also a classic 'My Computer' icon, except it features my ergonomic keyboard instead of a standard keyboard."
/>
...
[Read part three](/blog/building-my-new-website-part-3/)
