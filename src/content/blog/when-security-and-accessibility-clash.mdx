...
<div class="post-callout">
	<p>
		This is the process for me to pay myself from my business bank account using
		my computer. Unfortunately, due to needing developer and accessibility tools
		on my phone, it does not allow me to use the 'streamlined' process, but
		gives me a horrendous 2FA filled nightmare.
	</p>
	<ol>
		<li>Log in to my bank account on my desktop with a password manager.</li>
		<li>
			Authenticate the login by using the phone app to generate an 8 digit code,
			which I enter on my computer
		</li>
		<li>Type in the transaction details.</li>
		<li>Get a code via SMS.</li>
		<li>Enter a PIN number to unlock the phone app.</li>
		<li>
			Enter the SMS code into the transaction approval screen on the phone app.
		</li>
		<li>
			Get a response code from the phone app, which I now type into the desktop
			transaction approval screen.
		</li>
		<li>
			Contemplate if this whole internet business is really worth the hassle of
			not having to talk to a human person.
		</li>
	</ol>
</div>
