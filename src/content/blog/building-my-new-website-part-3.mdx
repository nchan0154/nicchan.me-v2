---
title: "Building my new website: Modern problems require Modern CSS techniques"
pubDate: "2024-03-06"
...
<Image
	src="https://res.cloudinary.com/nicchan/image/upload/v1709706012/personal-6.png"
	width="1024"
	height="768"
	alt="An about page, two windows, one with a bio and the other with a list of testimonials. The testimonials are styled like a chat interface."
/>
...
<Image
	src="https://res.cloudinary.com/nicchan/image/upload/v1709706012/personal-7.png"
	width="1024"
	height="768"
	alt="A sample blog post, where there is a window for a table of contents on the left, and the full post body on the right."
/>
