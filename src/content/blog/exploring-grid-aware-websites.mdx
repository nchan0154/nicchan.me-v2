...
pubDate: "2025-08-26"
description: "Is having websites respond to the user's energy grid a way to make more sustainable websites?"
tags:
  - sustainability
  - performance
  - javascript
...
<Image
	...
	width="1524"
	height="115"
	alt="The Green Web Foundation's grid-aware statusbar component features a location marker with the current Location (Hong Kong), text that says 'Your local grid: Around average emissions', and a switch toggle to enable the grid-aware auto mode."
/>
