---
title: "Building my new website: light-dark and blog posts"
pubDate: "2024-09-10"
description: "Finally making headway"
tags:
  - css
  - portfolio
image: https://res.cloudinary.com/nicchan/image/upload/w_1200,h_630,c_limit,f_auto/v1726638875/
alt: "The blog page on Nic Chan's personal site, but split in half, one half is in dark mode (white text on a purple background), and the other is in light mode (dark violet text on a white background)."
---
...
<Image
	src="https://res.cloudinary.com/nicchan/image/upload/v1725323189/personal-8.png"
	width="1024"
	height="768"
	alt="A blog page with a purple retro-styled Windows design. The largest window on the left has a list of all blog posts, and the right column has a list of blog post tags and an a11y-webring widget."
/>
...
<Image
	src="https://res.cloudinary.com/nicchan/image/upload/v1725323445/personal-9.png"
	width="1024"
	height="768"
	alt="A blog page with a purple retro-styled Windows design. The largest window on the left has a list of all blog posts, and the right column has a list of blog post tags and an a11y-webring widget."
/>

I do a whole bunch of work with the color variables to flesh out the light and dark themes a bit more. The new light-dark function puts in a bunch of work here, and I'm really excited we no longer have to use mixin based approaches in order to manage this without unneccessary duplication.

## Code styles

<Image
	src="https://res.cloudinary.com/nicchan/image/upload/v1725328992/code-styles.png"
	width="1282"
	height="694"
	alt="Side by side of a dark and light theme for code snippets. The dark theme is mostly shades of purple, and the light theme uses magenta, teal and purple."
/>
