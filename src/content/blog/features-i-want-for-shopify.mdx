...
<Image
	src="https://res.cloudinary.com/nicchan/image/upload/v1610102431/shopify-customizer.png"
	width="1920"
	height="937"
	alt="Shopify's Image picker UI, there is a tiny sidebar for images and the page UI takes the rest of the ginormous amount of space."
/>
